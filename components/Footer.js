  ...
  return (
    <div className="bg-white mt-16">
     ...
     <div className="bg-white  py-6 flex flex-col items-center md:flex-row lg:justify-between mb-10 space-y-6 md:space-y-0 md:gap-10">
      {/* Location */}
      <div className="flex items-center gap-10 md:gap-5 text-gray-700">
          {/* <MdLocationOn className="text-5xl text-[#B59C78]" /> */}
          <Image src='/images/icon2.png' alt="Logo" width={35}
           height={35}  />
          <p className="text-xl font-medium">1066 Epalinges, Switzerland</p>
        </div>
        ...
        {/* <div className="mt-6 flex flex-col space-y-2">
          ...
          <div className=" flex items-center gap-5 md:gap-5">
            <div className="w-[40px] h-[40px] ">
             <Image src='/images/icon1.png' alt="Logo" width={40}
           height={40}  />
...
<button
onClick={scrollToTop}
className="fixed bottom-10 right-6 flex items-center gap-1 text-[#b59c78] text-lg font-medium 
